...
#  Dec 19, 2020 06:09:35 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm deiconify $top
    wm title $top "zoom links for teacher"
    ...
    entry $top.ent50 \
        ...
        -selectforeground white -width 564 
    vTcl:DefineAlias "$top.ent50" "zoom_link_entry" vTcl:WidgetProc "zoom links teacher" 1
    label $top.lab51 \
    ...
    button $top.but46 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text הוספה 
    vTcl:DefineAlias "$top.but46" "entry_button" vTcl:WidgetProc "zoom links teacher" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but45 \
    ...
    place $top.but49 \
        ...
        -height 63 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent50 \
        -in $top -x 0 -relx 0.017 -y 0 -rely 0.778 -width 564 -relwidth 0 \
        -height 54 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lab51 \
        -in $top -x 0 -relx 0.667 -y 0 -rely 0.711 -width 0 -relwidth 0.287 \
        -height 0 -relheight 0.058 -anchor nw -bordermode ignore 
    place $top.but46 \
        -in $top -x 0 -relx 0.4 -y 0 -rely 0.911 -width 116 -relwidth 0 \
