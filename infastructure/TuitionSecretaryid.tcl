...
#  Dec 30, 2020 03:58:11 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    vTcl:DefineAlias "$top" "Tuitionsec" vTcl:Toplevel:WidgetProc "" 1
    set vTcl(real_top) {}
    vTcl:withBusyCursor {
    menu $top.m45 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
    ...
    vTcl:DefineAlias "$top.but46" "mainmenu" vTcl:WidgetProc "Tuitionsec" 1
    button $top.but47 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #ffb871 -cursor hand2 -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 10 -weight bold -slant roman -underline 0 -overstrike 0} \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text המשך 
    vTcl:DefineAlias "$top.but47" "nextpage" vTcl:WidgetProc "Tuitionsec" 1
    entry $top.ent53 \
    ...
    vTcl:DefineAlias "$top.ent53" "id_entry" vTcl:WidgetProc "Tuitionsec" 1
    message $top.mes54 \
        -background #ffcf9f \
    ...
    vTcl:DefineAlias "$top.mes54" "userDetails" vTcl:WidgetProc "Tuitionsec" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but46 \
