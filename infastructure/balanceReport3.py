...
#    Jan 02, 2021 03:23:06 PM +0200  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    balanceReport3_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    balanceReport3_support.init(w, top, *args, **kwargs)
    return (w, top)
