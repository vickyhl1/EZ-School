...
class Toplevel1:
    ...
    def Submit(self):
        if not self.CheckVar1.get():
            self.add_absence('304412060')
        if not self.CheckVar2.get():
            self.add_absence('333090942')
        if not self.CheckVar3.get():
            self.add_absence('210345678')
        if not self.CheckVar4.get():
            self.add_absence('298767673')
        if not self.CheckVar5.get():
            self.add_absence('120234567')
        if not self.CheckVar6.get():
            self.add_absence('110023334')
        if not self.CheckVar7.get():
            self.add_absence('189098098')
        if not self.CheckVar8.get():
            self.add_absence('574444099')
        if not self.CheckVar9.get():
            self.add_absence('122222111')
        if not self.CheckVar10.get():
            self.add_absence('476423233')
    ...
    def __init__(self, top=None):
        ...
        self.stud7.configure(text='''מאור מוהב 189098098''')
