...
#    Jan 07, 2021 05:27:35 PM +0200  platform: Windows NT
...
def vp_start_gui():
    ...
    Payment_Shop_Student_support.init(root, top)
    root.mainloop()
...
def create_shop_payment(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = shop_payment (w)
    Payment_Shop_Student_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class shop_payment:
    ...
    def submit(self):
        ...
        if flag:
            ...
            tk.messagebox._show('Shop', 'התשלום התקבל בהצלחה, הפריטים ישלחו אליך בקרוב')
            self.back()
    ...
    def __init__(self, top=None):
        ...
        self.id_entry.place(relx=0.433, rely=0.392, height=20, relwidth=0.189)
        ...
        self.year_entry.place(relx=0.511, rely=0.486, height=20, relwidth=0.11)
        ...
        self.month_entry.place(relx=0.524, rely=0.58, height=20, relwidth=0.11)
        ...
        self.total_cost.configure(cursor="fleur")
