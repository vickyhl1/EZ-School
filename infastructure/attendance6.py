...
import AbsenceReport6

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    attendance6_support.set_Tk_var()
    top = Toplevel1 (root)
    attendance6_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    attendance6_support.set_Tk_var()
    top = Toplevel1 (w)
    attendance6_support.init(w, top, *args, **kwargs)
    return (w, top)
