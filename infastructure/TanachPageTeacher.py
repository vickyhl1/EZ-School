...
#    Jan 05, 2021 01:13:24 PM +0200  platform: Windows NT
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    top = TanachPageTeacher (root)
    TanachPageTeacher_support.init(root, top)
    root.mainloop()

w = None
def create_TanachPageTeacher(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_TanachPageTeacher(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    top = TanachPageTeacher (w)
    TanachPageTeacher_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_TanachPageTeacher():
    global w
    w.destroy()
    w = None
