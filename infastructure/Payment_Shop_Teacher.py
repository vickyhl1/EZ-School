...
#    Jan 07, 2021 07:41:14 PM +0200  platform: Windows NT
...
import Payment_Shop_Teacher_support
...
def vp_start_gui():
    ...
    Payment_Shop_Teacher_support.init(root, top)
    root.mainloop()
...
def create_shop_payment(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = shop_payment (w)
    Payment_Shop_Teacher_support.init(w, top, *args, **kwargs)
    return (w, top)
