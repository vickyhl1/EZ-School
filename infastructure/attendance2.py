...
class Toplevel1:
    ...
    def Submit(self):
        if not self.CheckVar1.get():
            self.add_absence('309044070')
        if not self.CheckVar2.get():
            self.add_absence('123456790')
        if not self.CheckVar3.get():
            self.add_absence('143256788')
        if not self.CheckVar4.get():
            self.add_absence('988854321')
        if not self.CheckVar5.get():
            self.add_absence('111112341')
        if not self.CheckVar6.get():
            self.add_absence('123456900')
        if not self.CheckVar7.get():
            self.add_absence('123774688')
        if not self.CheckVar8.get():
            self.add_absence('205555287')
        if not self.CheckVar9.get():
            self.add_absence('111121111')
        if not self.CheckVar10.get():
            self.add_absence('320755581')
    ...
    def __init__(self, top=None):
        ...
        self.attendancereport.place(relx=0.01, rely=0.800, height=73, width=166)
