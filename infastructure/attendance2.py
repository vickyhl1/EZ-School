...
#    Dec 31, 2020 04:33:30 PM +0200  platform: Windows NT
...
import attendance2_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    attendance2_support.set_Tk_var()
    top = Toplevel1 (root)
    attendance2_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    attendance2_support.set_Tk_var()
    top = Toplevel1 (w)
    attendance2_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.stud1.configure(text='''נועה חמודה 309044070''')
        self.stud1.configure(variable=attendance2_support.che47)

        self.stud2 = tk.Checkbutton(top)
        self.stud2.place(relx=0.386, rely=0.181, relheight=0.061, relwidth=0.169)
        ...
        self.stud2.configure(text='''אלון טרי 123456790''')
        self.stud2.configure(variable=attendance2_support.che49)

        self.stud3 = tk.Checkbutton(top)
        self.stud3.place(relx=0.38, rely=0.24, relheight=0.061, relwidth=0.191)
        ...
        self.stud3.configure(text='''אמה ווטסון 143256788''')
        self.stud3.configure(variable=attendance2_support.che50)

        self.stud4 = tk.Checkbutton(top)
        self.stud4.place(relx=0.369, rely=0.3, relheight=0.061, relwidth=0.202)
        ...
        self.stud4.configure(text='''בן קיוסק 988854321''')
        self.stud4.configure(variable=attendance2_support.che51)

        self.stud5 = tk.Checkbutton(top)
        self.stud5.place(relx=0.375, rely=0.36, relheight=0.051, relwidth=0.197)
        ...
        self.stud5.configure(text='''יובל קיבוץ 111112341''')
        self.stud5.configure(variable=attendance2_support.che52)
        ...
        self.stud6.configure(text='''ישראל ישראלי 123456900''')
        self.stud6.configure(variable=attendance2_support.che53)

        self.stud7 = tk.Checkbutton(top)
        self.stud7.place(relx=0.38, rely=0.47, relheight=0.052, relwidth=0.191)
        ...
        self.stud7.configure(text='''ויולט לפאנק 123774688''')
        self.stud7.configure(variable=attendance2_support.che54)

        self.stud8 = tk.Checkbutton(top)
        self.stud8.place(relx=0.369, rely=0.519, relheight=0.063, relwidth=0.201)
        ...
        self.stud8.configure(text='''לירון נגר 205555287''')
        self.stud8.configure(variable=attendance2_support.che55)
        ...
        self.stud9.configure(text='''חמוד חמיד 111121111''')
        self.stud9.configure(variable=attendance2_support.che56)

        self.stud10 = tk.Checkbutton(top)
        self.stud10.place(relx=0.391, rely=0.628, relheight=0.05, relwidth=0.171)
        ...
        self.stud10.configure(text='''נגאש שמלש 320755581''')
        self.stud10.configure(variable=attendance2_support.che57)
        ...
        self.mainmenu.place(relx=0.01, rely=0.913, height=73, width=166)
