...
#    Dec 31, 2020 03:14:31 PM +0200  platform: Windows NT
...
import ScheForOneClass5_support
import classesSche
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    top = classes_Sche5 (root)
    ScheForOneClass5_support.init(root, top)
    root.mainloop()

w = None
def create_classes_Sche5(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_classes_Sche5(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    top = classes_Sche5 (w)
    ScheForOneClass5_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_classes_Sche5():
    global w
    w.destroy()
    w = None
...
class classes_Sche5:
    ...
    def __init__(self, top=None):
        ...
        self.tuesday1.configure(text='''Button''')
        ...
        self.sunday1.configure(text=self.Lesson('sunday5', 0))
        self.sunday2.configure(text=self.Lesson('sunday5', 1))
        self.sunday3.configure(text=self.Lesson('sunday5', 2))
        self.sunday4.configure(text=self.Lesson('sunday5', 4))
        self.sunday5.configure(text=self.Lesson('sunday5', 4))

        self.monday1.configure(text=self.Lesson('monday5', 0))
        self.monday2.configure(text=self.Lesson('monday5', 1))
        self.monday3.configure(text=self.Lesson('monday5', 2))
        self.monday4.configure(text=self.Lesson('monday5', 3))
        self.monday5.configure(text=self.Lesson('monday5', 4))

        self.tuesday1.configure(text=self.Lesson('tuesday5', 0))
        self.tuesday2.configure(text=self.Lesson('tuesday5', 1))
        self.tuesday3.configure(text=self.Lesson('tuesday5', 2))
        self.tuesday4.configure(text=self.Lesson('tuesday5', 3))
        self.tuesday5.configure(text=self.Lesson('tuesday5', 4))

        self.wednesday1.configure(text=self.Lesson('wednesday5', 0))
        self.wednesday2.configure(text=self.Lesson('wednesday5', 1))
        self.wednesday3.configure(text=self.Lesson('wednesday5', 2))
        self.wednesday4.configure(text=self.Lesson('wednesday5', 3))
        self.wednesday5.configure(text=self.Lesson('wednesday5', 4))

        self.thursday1.configure(text=self.Lesson('thursday5', 0))
        self.thursday2.configure(text=self.Lesson('thursday5', 1))
        self.thursday3.configure(text=self.Lesson('thursday5', 2))
        self.thursday4.configure(text=self.Lesson('thursday5', 3))
        self.thursday5.configure(text=self.Lesson('thursday5', 4))
