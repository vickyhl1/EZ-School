...
#    Dec 24, 2020 07:16:13 PM +0200  platform: Windows NT
...
import classes_support
import Studentmainmenu
import zoomlinksforstudents
import zoomlinksforstudents2
import zoomlinksforstudents3
import zoomlinksforstudents4
import zoomlinksforstudents5
import zoomlinksforstudents6
...
def create_class(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = classes (w)
    classes_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class classes:
    ...
    def classnumber2(self):
        root.destroy()
        zoomlinksforstudents2.vp_start_gui()
    def classnumber3(self):
        root.destroy()
        zoomlinksforstudents3.vp_start_gui()
    def classnumber4(self):
        root.destroy()
        zoomlinksforstudents4.vp_start_gui()
    def classnumber5(self):
        root.destroy()
        zoomlinksforstudents5.vp_start_gui()
    def classnumber6(self):
        root.destroy()
        zoomlinksforstudents6.vp_start_gui()
