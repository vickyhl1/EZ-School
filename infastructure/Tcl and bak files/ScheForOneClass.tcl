...
#  Dec 31, 2020 01:33:29 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top60 {base} {
    ...
    button $top.but57 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
    vTcl:DefineAlias "$top.but57" "sunday5" vTcl:WidgetProc "classes_Sche" 1
    button $top.but58 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #a6ffff -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text Button 
    vTcl:DefineAlias "$top.but58" "sunday3" vTcl:WidgetProc "classes_Sche" 1
    button $top.but59 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #a6ffff -disabledforeground #a3a3a3 -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
