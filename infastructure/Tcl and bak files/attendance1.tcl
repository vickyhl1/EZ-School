...
=======
#  Jan 02, 2021 02:45:59 PM +0200  platform: Windows NT
...
=======
    message $top.mes49 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {עדי כהן 123456789} -width 200 
    vTcl:DefineAlias "$top.mes49" "Message2" vTcl:WidgetProc "Toplevel1" 1
    message $top.mes50 \
        -background $vTcl(actual_gui_bg) -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {רפול עזריאייב 123456788} -width 159 
    vTcl:DefineAlias "$top.mes50" "Message3" vTcl:WidgetProc "Toplevel1" 1
    message $top.mes51 \
        -background $vTcl(actual_gui_bg) -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {אתי בלון 987654321} -width 150 
    vTcl:DefineAlias "$top.mes51" "Message4" vTcl:WidgetProc "Toplevel1" 1
    message $top.mes52 \
        -background $vTcl(actual_gui_bg) -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text Message -width 180 
    vTcl:DefineAlias "$top.mes52" "Message5" vTcl:WidgetProc "Toplevel1" 1
>>>>>>> 880b965bcf2f9e78016aa3eee89c113c6bcd346e
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.che47 \
        -in $top -x 0 -relx 0.385 -y 0 -rely 0.133 -width 0 -relwidth 0.181 \
...
=======
    place $top.mes49 \
        -in $top -x 0 -relx 0.198 -y 0 -rely 0.143 -width 0 -relwidth 0.104 \
        -height 0 -relheight 0.022 -anchor nw -bordermode ignore 
    place $top.mes50 \
        -in $top -x 0 -relx 0.214 -y 0 -rely 0.2 -width 0 -relwidth 0.083 \
        -height 0 -relheight 0.022 -anchor nw -bordermode ignore 
    place $top.mes51 \
        -in $top -x 0 -relx 0.188 -y 0 -rely 0.247 -width 0 -relwidth 0.078 \
        -height 0 -relheight 0.022 -anchor nw -bordermode ignore 
    place $top.mes52 \
        -in $top -x 0 -relx 0.219 -y 0 -rely 0.304 -width 0 -relwidth 0.094 \
        -height 0 -relheight 0.022 -anchor nw -bordermode ignore 
>>>>>>> 880b965bcf2f9e78016aa3eee89c113c6bcd346e
