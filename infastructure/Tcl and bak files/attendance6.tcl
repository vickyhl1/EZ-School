...
#  Dec 31, 2020 04:58:54 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    checkbutton $top.che47 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {וין דיזל 324982135} -variable che47 
    ...
    checkbutton $top.che49 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {כריס פראט 3128772215} -variable che49 
    ...
    checkbutton $top.che50 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {זואי סלדנה 231145678} -variable che50 
    ...
    checkbutton $top.che51 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {בראדלי קופר 312555673} -variable che51 
    ...
    checkbutton $top.che52 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {דייב בטיסטה 312545673} -variable che52 
    ...
    checkbutton $top.che53 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {קארן גילאן 213522324} -variable che53 
    ...
    checkbutton $top.che54 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {סת' גרין 322171742} -variable che54 
    ...
    checkbutton $top.che55 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {מייקל רוקר 322131009} -variable che55 
    ...
    checkbutton $top.che56 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {מילה קוניס 312246583} -variable che56 
    ...
    checkbutton $top.che57 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {כריסטופר פיירבנק 238723233} -variable che57 
    ...
    place $top.che47 \
        -in $top -x 0 -relx 0.323 -y 0 -rely 0.133 -width 0 -relwidth 0.244 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che49 \
        -in $top -x 0 -relx 0.365 -y 0 -rely 0.181 -width 0 -relwidth 0.184 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che50 \
        -in $top -x 0 -relx 0.333 -y 0 -rely 0.238 -width 0 -relwidth 0.238 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che51 \
        -in $top -x 0 -relx 0.349 -y 0 -rely 0.295 -width 0 -relwidth 0.213 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che52 \
        -in $top -x 0 -relx 0.339 -y 0 -rely 0.362 -width 0 -relwidth 0.233 \
        -height 0 -relheight 0.051 -anchor nw -bordermode ignore 
    place $top.che53 \
        -in $top -x 0 -relx 0.334 -y 0 -rely 0.41 -width 0 -relwidth 0.238 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che54 \
        -in $top -x 0 -relx 0.323 -y 0 -rely 0.47 -width 0 -relwidth 0.248 \
        -height 0 -relheight 0.052 -anchor nw -bordermode ignore 
    place $top.che55 \
        -in $top -x 0 -relx 0.334 -y 0 -rely 0.514 -width 0 -relwidth 0.237 \
        -height 0 -relheight 0.062 -anchor nw -bordermode ignore 
    place $top.che56 \
        -in $top -x 0 -relx 0.333 -y 0 -rely 0.571 -width 0 -relwidth 0.238 \
        -height 0 -relheight 0.051 -anchor nw -bordermode ignore 
    place $top.che57 \
        -in $top -x 0 -relx 0.376 -y 0 -rely 0.628 -width 0 -relwidth 0.186 \
