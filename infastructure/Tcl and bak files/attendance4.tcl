...
#  Dec 31, 2020 04:41:32 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    checkbutton $top.che47 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {נדב ישי 304412060} -variable che47 
    ...
    checkbutton $top.che49 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {דניאל דהן 333090942} -variable che49 
    ...
    checkbutton $top.che50 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {ינון חדד 210345678} -variable che50 
    ...
    checkbutton $top.che51 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {שי ויצמן 298767673} -variable che51 
    ...
    checkbutton $top.che52 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {רוני ג'ק ויטולי 120234567} -variable che52 
    ...
    checkbutton $top.che53 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {גל אלוני 110023334} -variable che53 
    ...
    checkbutton $top.che54 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {מאור מוהב 1890980988} -variable che54 
    ...
    checkbutton $top.che55 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {שי לי 574444090} -variable che55 
    ...
    checkbutton $top.che56 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {יעל שלוש 122222111} -variable che56 
    ...
    checkbutton $top.che57 \
        ...
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -justify left -text {נאור גרינבאום 476423233} -variable che57 
    ...
    place $top.che49 \
        ...
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che50 \
        -in $top -x 0 -relx 0.349 -y 0 -rely 0.238 -width 0 -relwidth 0.222 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che51 \
        -in $top -x 0 -relx 0.353 -y 0 -rely 0.3 -width 0 -relwidth 0.218 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che52 \
        -in $top -x 0 -relx 0.375 -y 0 -rely 0.362 -width 0 -relwidth 0.197 \
        -height 0 -relheight 0.051 -anchor nw -bordermode ignore 
    place $top.che53 \
        -in $top -x 0 -relx 0.354 -y 0 -rely 0.41 -width 0 -relwidth 0.218 \
        -height 0 -relheight 0.061 -anchor nw -bordermode ignore 
    place $top.che54 \
        -in $top -x 0 -relx 0.37 -y 0 -rely 0.47 -width 0 -relwidth 0.201 \
        -height 0 -relheight 0.052 -anchor nw -bordermode ignore 
    place $top.che55 \
        -in $top -x 0 -relx 0.339 -y 0 -rely 0.514 -width 0 -relwidth 0.232 \
