...
#  Jan 07, 2021 09:53:36 PM +0200  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    wm geometry $top 600x450+652+264
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    wm deiconify $top
    wm title $top "תשלום חנות עבור תלמיד"
    vTcl:DefineAlias "$top" "shopsec" vTcl:Toplevel:WidgetProc "" 1
    set vTcl(real_top) {}
    vTcl:withBusyCursor {
    menu $top.m45 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
    ...
    button $top.but46 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #ffb871 -cursor hand2 -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 10 -weight bold -slant roman -underline 0 -overstrike 0} \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text {תפריט ראשי} 
    vTcl:DefineAlias "$top.but46" "mainmenu" vTcl:WidgetProc "shopsec" 1
    button $top.but47 \
        -activebackground $vTcl(analog_color_m) -activeforeground #000000 \
        -background #ffb871 -cursor hand2 -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI} -size 10 -weight bold -slant roman -underline 0 -overstrike 0} \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -pady 0 -text המשך 
    vTcl:DefineAlias "$top.but47" "nextpage" vTcl:WidgetProc "shopsec" 1
    entry $top.ent53 \
    ...
    vTcl:DefineAlias "$top.ent53" "id_entry" vTcl:WidgetProc "shopsec" 1
    message $top.mes54 \
        -background #ffcf9f \
        -font {-family {Segoe UI} -size 11 -weight bold -slant roman -underline 0 -overstrike 0} \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {הכנס מספר תעודת זהות של התלמיד עבורו מתבצע התשלום} -width 460 
    vTcl:DefineAlias "$top.mes54" "userDetails" vTcl:WidgetProc "shopsec" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.but46 \
    ...
    place $top.but47 \
        -in $top -x 0 -relx 0.383 -y 0 -rely 0.422 -width 127 -relwidth 0 \
        -height 34 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent53 \
        -in $top -x 0 -relx 0.367 -y 0 -rely 0.311 -width 154 -relwidth 0 \
        -height 30 -relheight 0 -anchor nw -bordermode ignore 
    place $top.mes54 \
        -in $top -x 0 -relx 0.133 -y 0 -rely 0.2 -width 0 -relwidth 0.767 \
