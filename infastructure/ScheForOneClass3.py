...
#    Dec 31, 2020 02:54:08 PM +0200  platform: Windows NT
...
import ScheForOneClass3_support
import classesSche
...
def vp_start_gui():
    ...
    ScheForOneClass3_support.init(root, top)
    root.mainloop()
...
def create_classes_Sche3(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = classes_Sche3 (w)
    ScheForOneClass3_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class classes_Sche3:
    ...
    def __init__(self, top=None):
        ...
        self.sunday1.configure(text=self.Lesson('sunday3', 0))
        self.sunday2.configure(text=self.Lesson('sunday3', 1))
        self.sunday3.configure(text=self.Lesson('sunday3', 2))
        self.sunday4.configure(text=self.Lesson('sunday3', 4))
        self.sunday5.configure(text=self.Lesson('sunday3', 4))

        self.monday1.configure(text=self.Lesson('monday3', 0))
        self.monday2.configure(text=self.Lesson('monday3', 1))
        self.monday3.configure(text=self.Lesson('monday3', 2))
        self.monday4.configure(text=self.Lesson('monday3', 3))
        self.monday5.configure(text=self.Lesson('monday3', 4))

        self.tuesday1.configure(text=self.Lesson('tuesday3', 0))
        self.tuesday2.configure(text=self.Lesson('tuesday3', 1))
        self.tuesday3.configure(text=self.Lesson('tuesday3', 2))
        self.tuesday4.configure(text=self.Lesson('tuesday3', 3))
        self.tuesday5.configure(text=self.Lesson('tuesday3', 4))

        self.wednesday1.configure(text=self.Lesson('wednesday3', 0))
        self.wednesday2.configure(text=self.Lesson('wednesday3', 1))
        self.wednesday3.configure(text=self.Lesson('wednesday3', 2))
        self.wednesday4.configure(text=self.Lesson('wednesday3', 3))
        self.wednesday5.configure(text=self.Lesson('wednesday3', 4))

        self.thursday1.configure(text=self.Lesson('thursday3', 0))
        self.thursday2.configure(text=self.Lesson('thursday3', 1))
        self.thursday3.configure(text=self.Lesson('thursday3', 2))
        self.thursday4.configure(text=self.Lesson('thursday3', 3))
        self.thursday5.configure(text=self.Lesson('thursday3', 4))
