...
#    Jan 07, 2021 12:17:42 PM +0200  platform: Windows NT
...
import teacher_shop_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    top = teacher_shop (root)
    teacher_shop_support.init(root, top)
    root.mainloop()

w = None
def create_teacher_shop(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_teacher_shop(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    top = teacher_shop (w)
    teacher_shop_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_teacher_shop():
    global w
    w.destroy()
    w = None
...
class teacher_shop:
    def __init__(self, top=None):
        ...
        self.pencil_stock.configure(text='''Button''')
        ...
        self.black_pen_stock.configure(text='''Button''')
        ...
        self.math_paper_stock.configure(text='''Button''')
        ...
        self.markers_stock.configure(text='''Button''')
        ...
        self.stripe_paper_stock.configure(text='''Button''')
        ...
        self.binder_stock.configure(text='''Button''')
        ...
        self.total_cost = tk.Button(top)
        self.total_cost.place(relx=0.513, rely=0.907, height=53, width=156)
        self.total_cost.configure(activebackground="#ececec")
        self.total_cost.configure(activeforeground="#000000")
        self.total_cost.configure(background="#d3bdd9")
        self.total_cost.configure(disabledforeground="#a3a3a3")
        ...
        self.total_cost.configure(text='''0''')
        ...
        self.payment_button.configure(text='''לתשלום''')
        ...
        self.pencil_q_msg.configure(text='''0''')
        ...
        self.black_pen_q_msg.configure(text='''0''')
        ...
        self.Message4.configure(text='''0''')
        ...
        self.Message5.configure(text='''0''')
        ...
        self.strip_paper_msg.configure(text='''דפדפת חשבון''')
        ...
        self.Message6.configure(text='''0''')
        ...
        self.Message8.configure(text='''0''')
        self.Message8.configure(width=70)

        self.discount_msg = tk.Message(top)
        self.discount_msg.place(relx=0.035, rely=0.053, relheight=0.527
                , relwidth=0.217)
        self.discount_msg.configure(background="#7cacf3")
        self.discount_msg.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.discount_msg.configure(foreground="#eb0214")
        self.discount_msg.configure(highlightbackground="#d9d9d9")
        self.discount_msg.configure(highlightcolor="#000000")
        self.discount_msg.configure(text='''שים לב,
לאחר לחיצה על תשלום
יעודכן המחיר הסופי עם הנחה של 10%''')
        self.discount_msg.configure(width=245)
