...
#    Jan 03, 2021 02:24:26 PM +0200  platform: Windows NT
...
import GamesForTeacher_support
import webbrowser
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    GamesForTeacher_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    GamesForTeacher_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        self.Add_game = tk.Button(top)
        self.Add_game.place(relx=0.65, rely=0.733, height=24, width=57)
        self.Add_game.configure(activebackground="#ececec")
        self.Add_game.configure(activeforeground="#000000")
        self.Add_game.configure(background="#d9d9d9")
        self.Add_game.configure(cursor="hand2")
        self.Add_game.configure(disabledforeground="#a3a3a3")
        self.Add_game.configure(foreground="#000000")
        self.Add_game.configure(highlightbackground="#d9d9d9")
        self.Add_game.configure(highlightcolor="black")
        self.Add_game.configure(pady="0")
        self.Add_game.configure(text='''הוסף''')
        self.Add_game.configure(command=self.newLink)
        ...
        self.Label2.place(relx=0.75, rely=0.667, height=21, width=134)
        self.Label2.configure(background="#ff80c0")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.Label2.configure(foreground="#000000")
        self.Label2.configure(text=''':הכנס משחק נוסף''')

        self.Entry1 = tk.Entry(top)
        self.Entry1.place(relx=0.033, rely=0.644, height=30, relwidth=0.707)
