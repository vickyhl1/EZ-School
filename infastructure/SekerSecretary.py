...
#    Dec 29, 2020 08:34:40 PM +0200  platform: Windows NT
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    SekerSecretary_support.set_Tk_var()
    top = Seker (root)
    SekerSecretary_support.init(root, top)
    root.mainloop()
...
def create_Seker(rt, *args, **kwargs):
    ...
    SekerSecretary_support.set_Tk_var()
    top = Seker (w)
    SekerSecretary_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Seker:
    ...
    def __init__(self, top=None):
        ...
        self.Question1.configure(values=self.value_list)
        ...
        self.Question2.configure(values=self.value_list)
...
ברמה מועטה - 3''')
        ...
        self.PublishSeker = tk.Button(top)
        self.PublishSeker.place(relx=0.249, rely=0.908, height=44, width=97)
        self.PublishSeker.configure(activebackground="#ececec")
        self.PublishSeker.configure(activeforeground="#000000")
        self.PublishSeker.configure(background="#d9d9d9")
        self.PublishSeker.configure(cursor="hand2")
        self.PublishSeker.configure(disabledforeground="#a3a3a3")
        self.PublishSeker.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.PublishSeker.configure(foreground="#000000")
        self.PublishSeker.configure(highlightbackground="#d9d9d9")
        self.PublishSeker.configure(highlightcolor="black")
        self.PublishSeker.configure(pady="0")
        self.PublishSeker.configure(text='''פרסם סקר''')
        ...
        self.Unpublish = tk.Button(top)
        self.Unpublish.place(relx=0.337, rely=0.908, height=44, width=87)
        self.Unpublish.configure(activebackground="#ececec")
        self.Unpublish.configure(activeforeground="#000000")
        self.Unpublish.configure(background="#d9d9d9")
        self.Unpublish.configure(disabledforeground="#a3a3a3")
        self.Unpublish.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.Unpublish.configure(foreground="#000000")
        self.Unpublish.configure(highlightbackground="#d9d9d9")
        self.Unpublish.configure(highlightcolor="black")
        self.Unpublish.configure(pady="0")
        self.Unpublish.configure(text='''בטל פרסום''')

        self.ReportButton = tk.Button(top)
        self.ReportButton.place(relx=0.41, rely=0.908, height=44, width=87)
        ...
        self.ReportButton.configure(font="-family {Segoe UI} -size 9 -weight bold")
        ...
        self.ReportButton.configure(text='''הפק דו"ח''')
