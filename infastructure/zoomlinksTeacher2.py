...
#    Dec 26, 2020 02:40:06 PM +0200  platform: Windows NT
...
import zoomlinksTeacher2_support
import webbrowser
...
def vp_start_gui():
    ...
    zoomlinksTeacher2_support.init(root, top)
    root.mainloop()
...
def create_zoom_links_teacher(rt, *args, **kwargs):
    ...
    zoomlinksTeacher2_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class zoom_links_teacher:
    ...
    def __init__(self, top=None):
        ...
        top.resizable(1,  1)
        top.title("קישורי זום למורה-כיתב ב")
