...
#    Jan 04, 2021 11:43:21 AM +0200  platform: Windows NT
...
import classesattendance_support
import attendance1
import attendance2
import attendance3
import attendance4
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = classes(root)
    classesattendance_support.init(root, top)
    root.mainloop()
...
def create_class(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = classes(w)
    classesattendance_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class classes:
    def openclass1(self):
        root.destroy()
        attendance1.vp_start_gui()
    def openclass2(self):
        root.destroy()
        attendance2.vp_start_gui()
    def openclass3(self):
        root.destroy()
        attendance3.vp_start_gui()
    def openclass4(self):
        root.destroy()
        attendance4.vp_start_gui()
    def openclass5(self):
        root.destroy()
        attendance5.vp_start_gui()
    def openclass6(self):
        root.destroy()
