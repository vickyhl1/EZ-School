...
#    Dec 31, 2020 03:22:25 PM +0200  platform: Windows NT
...
import ScheForOneClass6_support
import classesSche
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    top = classes_Sche6 (root)
    ScheForOneClass6_support.init(root, top)
    root.mainloop()

w = None
def create_classes_Sche6(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_classes_Sche6(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    top = classes_Sche6 (w)
    ScheForOneClass6_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_classes_Sche6():
    global w
    w.destroy()
    w = None
...
class classes_Sche6:
    ...
    def __init__(self, top=None):
        ...
        self.sunday1.configure(text=self.Lesson('sunday6', 0))
        self.sunday2.configure(text=self.Lesson('sunday6', 1))
        self.sunday3.configure(text=self.Lesson('sunday6', 2))
        self.sunday4.configure(text=self.Lesson('sunday6', 4))
        self.sunday5.configure(text=self.Lesson('sunday6', 4))

        self.monday1.configure(text=self.Lesson('monday6', 0))
        self.monday2.configure(text=self.Lesson('monday6', 1))
        self.monday3.configure(text=self.Lesson('monday6', 2))
        self.monday4.configure(text=self.Lesson('monday6', 3))
        self.monday5.configure(text=self.Lesson('monday6', 4))

        self.tuesday1.configure(text=self.Lesson('tuesday6', 0))
        self.tuesday2.configure(text=self.Lesson('tuesday6', 1))
        self.tuesday3.configure(text=self.Lesson('tuesday6', 2))
        self.tuesday4.configure(text=self.Lesson('tuesday6', 3))
        self.tuesday5.configure(text=self.Lesson('tuesday6', 4))

        self.wednesday1.configure(text=self.Lesson('wednesday6', 0))
        self.wednesday2.configure(text=self.Lesson('wednesday6', 1))
        self.wednesday3.configure(text=self.Lesson('wednesday6', 2))
        self.wednesday4.configure(text=self.Lesson('wednesday6', 3))
        self.wednesday5.configure(text=self.Lesson('wednesday6', 4))

        self.thursday1.configure(text=self.Lesson('thursday6', 0))
        self.thursday2.configure(text=self.Lesson('thursday6', 1))
        self.thursday3.configure(text=self.Lesson('thursday6', 2))
        self.thursday4.configure(text=self.Lesson('thursday6', 3))
        self.thursday5.configure(text=self.Lesson('thursday6', 4))
